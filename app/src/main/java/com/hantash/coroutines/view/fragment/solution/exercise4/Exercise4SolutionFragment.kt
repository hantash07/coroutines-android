...
class Exercise4SolutionFragment : Fragment() {
    private lateinit var binding: FragmentExercise1Binding
    private lateinit var reputationUseCase: GetReputationUseCase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reputationUseCase = GetReputationUseCase(GetReputationEndpoint())
    }
    ...
    override fun onCreateView(
        ...
        binding.btnGetReputation.setOnClickListener {
            ...
            job = coroutineScope.launch {
                ...
                val reputation = reputationUseCase.getReputationForUser(binding.etUserId.text.toString())
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Exercise4SolutionFragment()
    }
