...
class Exercise6SolutionFragment : Fragment() {
    private lateinit var binding: FragmentExercise6Binding
    private lateinit var fetchAndCacheUsersUseCase: Exercise6SolutionFetchAndCacheUsersUseCase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fetchAndCacheUsersUseCase = Exercise6SolutionFetchAndCacheUsersUseCase(GetUserEndpoint(), UsersDao())
    }
    ...
    companion object {
        @JvmStatic
        fun newInstance() = Exercise6SolutionFragment()
    }
}